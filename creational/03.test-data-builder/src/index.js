/*
  ...
  Price: shloud be from zero to a thousand
  Catagory: should be eletronic or organic
*/
...
function productValidator(product) {
  ...
  if(!(["eletronic","organic"].includes(product.category))){
    errors.push(`category: invalid value, current [${product.category}] expected to be eletronic or organic`)
  }
